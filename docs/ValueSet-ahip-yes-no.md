...
| | |
| :--- | :--- |
| *Official URL*:http://ahip.org/demographics/ValueSet/ahip-yes-no | *Version*:0.1.0 |
| Draft as of 2025-03-24 | *Computable Name*:AHIPDemoYesNo |
...
```json
{
  ...
  "id" : "ahip-yes-no",
  "url" : "http://ahip.org/demographics/ValueSet/ahip-yes-no",
  "version" : "0.1.0",
  "name" : "AHIPDemoYesNo",
